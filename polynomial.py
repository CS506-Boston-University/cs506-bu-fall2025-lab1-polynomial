...
class Add:
    ...
    def evaluate(self, x_value):
        ...
        # ((self.p1).evaluate(x_value) + (self.p2).evaluate(x_value))
        """
        print(self.p1)
        print(self.p2)
        print(self.p1.evaluate(x_value))
        print(self.p2.evaluate(x_value))
        print(self.p1.evaluate(x_value) + self.p2.evaluate(x_value))
