...
class Int:
    ...
    def evaluate(self, x_value):
        ...
        return Int(self.i) # I could just return self, but I just want to do copy to be sure
...
class Mul:
    ...
    def __repr__(self):
        # add or sub just means we need parentheses because they are lower precedence
